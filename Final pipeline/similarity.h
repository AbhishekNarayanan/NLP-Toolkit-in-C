...
static int levenshteinEdits(char *a, char *b);//also prints the edits required to change string2 to string1
static int levenshteinDistance(char *a, char *b);
...
static double cosine_similarity(double *A, double *B, int len);
//takes binary vectors(output of bag of words)
static double jaccard_similarity(int *A, int *B, int len);



//min edit distance(3 options of editing: insert, remove or replace)
static int levenshteinEdits(char *a, char *b) {
